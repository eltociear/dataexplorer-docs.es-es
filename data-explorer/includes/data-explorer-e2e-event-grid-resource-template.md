...
ms.locfileid: "81492608"
---
## <a name="azure-resource-manager-template"></a>Plantilla del Administrador de recursos de Azure

En este artículo, se usa una plantilla de Azure Resource Manager para crear un grupo de recursos mediante programación, una cuenta de almacenamiento y un contenedor, un centro de eventos y un clúster y una base de datos de Azure Data Explorer. Guarde el siguiente contenido en un archivo con el nombre `template.json`. Usará este archivo para ejecutar el ejemplo de código.
