...
:::image type="content" source="images/queries/activity-metrics-churn-and-retention.png" border="false" alt-text="Rotación y retención de métricas de actividad":::
...
:::image type="content" source="images/queries/activity-metrics-dcount-and-dcount-newvalues.png" border="false" alt-text="Las métricas de actividad cuentan y cuentan los nuevos valores":::
